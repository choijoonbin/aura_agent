...
2026-03-04 11:21:54.526 Uncaught app execution
Traceback (most recent call last):
  File "/Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/streamlit/runtime/scriptrunner/exec_code.py", line 121, in exec_func_with_error_handling
    result = func()
  File "/Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/streamlit/runtime/scriptrunner/script_runner.py", line 591, in code_to_exec
    exec(code, module.__dict__)
    ~~~~^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/joonbinchoi/Work/AuraAgent/app.py", line 26, in <module>
    render_dashboard_page()
    ~~~~~~~~~~~~~~~~~~~~~^^
  File "/Users/joonbinchoi/Work/AuraAgent/ui/dashboard.py", line 410, in render_dashboard_page
    _render_overview_tab(frame)
    ~~~~~~~~~~~~~~~~~~~~^^^^^^^
  File "/Users/joonbinchoi/Work/AuraAgent/ui/dashboard.py", line 183, in _render_overview_tab
    _render_line_plot(
    ~~~~~~~~~~~~~~~~~^
        quality_trend,
        ^^^^^^^^^^^^^^
    ...
    ^
  File "/Users/joonbinchoi/Work/AuraAgent/ui/dashboard.py", line 142, in _render_line_plot
    fig.update_layout(**_plotly_layout())
    ~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^
  File "/Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/plotly/graph_objs/_figure.py", line 218, in update_layout
    return super().update_layout(dict1, overwrite, **kwargs)
           ~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/plotly/basedatatypes.py", line 1415, in update_layout
    self.layout.update(dict1, overwrite=overwrite, **kwargs)
    ~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/plotly/basedatatypes.py", line 5195, in update
    BaseFigure._perform_update(self, kwargs, overwrite=overwrite)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/plotly/basedatatypes.py", line 3971, in _perform_update
    BaseFigure._perform_update(plotly_obj[key], val)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^
  File "/Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/plotly/basedatatypes.py", line 3949, in _perform_update
    raise err
